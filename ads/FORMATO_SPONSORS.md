  ...
  sponsors/
    <sponsor_id>/
      main/
        ...
        hero.jpg             # fallback
        logo.svg             # ideal (1:1, transparente)
        logo.webp            # recomendado (1:1)
        logo.png             # fallback (1:1)
...
### Logo (para la grilla de comercios)
Esta pieza se usa en las pantallas **Rubro → Comercios**, donde el logo toma protagonismo.

- **Formato ideal:** `SVG` (fondo transparente)
- **Alternativa:** `WEBP` o `PNG` (fondo transparente)
- **Relación:** **1:1 (cuadrado)**
- **Tamaño recomendado:** **512×512** (también sirve 640×640)
- **Peso objetivo:** 10–80 KB (mientras más liviano, mejor)
  ...
  "sponsors": [
    {
      ...
      "main": {
        ...
        "logo_webp": "main/logo.webp",
        "logo_fallback": "main/logo.png",
