document.addEventListener('DOMContentLoaded', () => {
    ...
    const datosHorarios = {
        ...
        "sabados": [
            ...
            {"Salida del Cruce": "18:57", "Terminal": "19:07", "Balcarce y Urquiza": "19:20", "L.Guillet y G. Paz": "19:26", "Entrada Ate II": "19:38", "Salida F. Sarmiento": "19:50", "Nelson e Irigoyen": "20:02", "Gral. Paz y Maipú": null, "Llega Cruce descanso": "20:24"},
        ...
        "domingos": [
            ...
            {"Salida del Cruce": "22:19", "Terminal": "22:28", "Balcarce y Urquiza": "22:38", "L.Guillet y G. Paz": "22:44", "Entrada Ate II": "22:56", "Salida F. Sarmiento": "23:09", "Nelson e Irigoyen": "23:21", "Gral. Paz y Maipú": "23:33", "Llega Cruce descanso": "23:43"},
    ...
    function iniciarApp() {
        ...
        // Detectar día para cargar la lista correcta
    ...
    function llenarSelector() {
        // Obtenemos las paradas basándonos en la primera fila válida del día actual
        // Buscamos una fila que tenga la mayoría de los datos
    ...
    function actualizarTimeline() {
        ...
        for (let i = 0; i < viajesValidos.length; i++) {
            ...
            // Ajuste madrugada (si es < 4 AM, le sumamos 24hs)
        ...
        if (indiceProximo !== -1) {
            ...
            if (dif === 0) {
                ...
                mainCountdown.style.background = "#4caf50"; // Verde
            } else if (dif < 60) {
                mainCountdown.textContent = `En ${dif} min`;
                mainCountdown.style.background = "rgba(0,0,0,0.2)";
            } else {
    ...
    function mostrarTablas() {
        ...
        // Por defecto cargar Lunes a Viernes o el día actual
    ...
    function renderizarTabla(keyDia) {
        ...
        // Crear Encabezados
        // Usamos una fila que tenga datos para sacar las columnas
