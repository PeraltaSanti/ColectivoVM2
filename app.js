document.addEventListener('DOMContentLoaded', () => {
    ...
    const DEFAULT_OVERLAY_DARK = { top: 0.08, mid: 0.20, bot: 0.52 };
    const DEFAULT_OVERLAY_LIGHT = { top: 0.08, mid: 0.12, bot: 0.22 };
    ...
    const DEFAULT_APP_SKIN = {
        ...
        // Queremos que la marca se vea (sin blur fuerte)
        opacity_dark: 0.98,
        opacity_light: 0.55,
        blur_px: 0,
        scale: 1.02,
    ...
    function applyBrandSkin(skin) {
        ...
        // Reducimos los "glows" cuando hay sponsor takeover para que la foto se vea
