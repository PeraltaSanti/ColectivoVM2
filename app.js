document.addEventListener('DOMContentLoaded', () => {
    ...
    const ADS_DEFAULT_ROTATE_MS = 20000;
    let adsCfg = null;
    let adsTimer = null;
    let adsLastId = null;
    ...
    async function initAds() {
        ...
        // settings
        adsRotateMs = loadAdsSettings().rotate_ms;
    ...
    function renderAdminStats() {
        ...
        if (!rows.length) {
            ...
            html.push('<div class="admin-section" style="overflow:auto;">
...
// --- HELPERS ---
    ...
    function aplicarLinea(nuevaLinea, opts = {}) {
        ...
        // refrescar publicidad (por si está segmentada por línea)
        showNextAd();
    ...
    function aplicarTemporada(nuevaTemporada) {
        ...
        // refrescar publicidad (por si está segmentada)
        showNextAd();
