document.addEventListener('DOMContentLoaded', () => {
    ...
    function iniciarApp() {
        ...
        // Temporada (por selector)
        temporadaActual = selectorTemporada ? selectorTemporada.value : 'regular';
        const temporadaValida = datosHorarios[temporadaActual] ? temporadaActual : 'regular';
        ...
        listaViajesActual = datosHorarios[temporadaValida][diaActualKey] || [];
    ...
    if (selectorTemporada) {
        selectorTemporada.addEventListener('change', () => {
            temporadaActual = selectorTemporada.value || 'regular';

            // Recalcular lista del día según temporada seleccionada
            const fecha = new Date();
